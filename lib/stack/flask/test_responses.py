...
def test_build_success_response_wraps_data_and_defaults_to_200():
    ...
    assert response.get_json() == {"success": True, "data": {"a": 1}, "error": None}
...
def test_build_success_response_defaults_data_to_none():
    ...
    assert response.get_json() == {"success": True, "data": None, "error": None}
...
def test_build_error_response_wraps_message_and_defaults_to_400():
    ...
    assert response.get_json() == {"success": False, "data": None, "error": "something broke"}
